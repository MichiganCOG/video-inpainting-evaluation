...
from ...models.flownet2.networks.channelnorm_package.channelnorm import ChannelNorm

from ...models.flownet2.networks import FlowNetC, FlowNetFusion, FlowNetSD, FlowNetS
...
class FlowNet2(nn.Module):
    ...
    def forward(self, img1, img2):
        inputs = torch.stack([img1, img2], dim=2)
